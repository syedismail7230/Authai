...
const Layout: React.FC<LayoutProps> = ({ children, credits, currentView, user, onNavigate, onLoginClick }) => {
  return (
    <div className="min-h-screen bg-neutral-100 text-neo-black font-sans selection:bg-neo-black selection:text-neo-white">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 w-full z-50 bg-white border-b-4 border-neo-black px-4 py-3 flex justify-between items-center">
        <div 
        ...
        <div className="flex items-center gap-2 md:gap-4">
           ...
           <button className="p-2 border-2 border-neo-black hover:bg-neo-black hover:text-white transition-colors md:hidden">
             <Menu size={24} />
           </button>
        </div>
      </nav>
